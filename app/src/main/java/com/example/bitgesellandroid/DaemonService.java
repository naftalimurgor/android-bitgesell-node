package com.example.bitgesellandroid;
...
public class DaemonService extends Service {
    ...
    private static final String NOTIFICATION_CHANNEL_DAEMON = "com.example.bitgesellandroid.CHANNEL_DAEMON";
    ...
    private Notification createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), NOTIFICATION_CHANNEL_DAEMON)
                .setContentTitle("BitgesellCore daemon running:")
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (manager != null) {
                manager.createNotificationChannel(new NotificationChannel(
                        ...
                        "BitgesellCore daemon notification",
...
//        String params = df.read();
        ...
        worker_ = new ProcessWorker(this, "libbitgesell.so", params, !params.contains("-help"));
...
/*        if (result.contains("Cannot obtain a lock on data directory")) {
            ...
            try {
                ...
                while ((line = r.readLine()) != null) {
                    if (line.contains("libbitgesell.so")) {
